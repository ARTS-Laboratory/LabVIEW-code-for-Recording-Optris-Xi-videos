...
The software development kit (SDK) must be installed for the code to function. The installer can be found in [here](LabVIEW-code-for-Recording-Optris-Xi-videos\software\SDK\otcsdk-11.3.0-amd64.exe). 
